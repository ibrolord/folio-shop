...
- SAVE10 promo not applied → [PR #1](https://github.com/ibrolord/folio-shop/pull/1)
- Newsletter rejects valid emails → [PR #2](https://github.com/ibrolord/folio-shop/pull/2)
- Search is case-sensitive → [PR #3](https://github.com/ibrolord/folio-shop/pull/3)
