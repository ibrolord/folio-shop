...
(function () {
  // Don't load the QA widget on local/CI hosts. AnnotateQA reproduces bugs by
  // serving this site at 127.0.0.1 and asserting the console is clean, so the
  // widget (a third-party script) must stay out of that environment.
